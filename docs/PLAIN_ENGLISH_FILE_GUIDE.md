...
| `docs/FIGURE_INTERPRETATION_GUIDE.md` | Explains every final figure and R visualization in plain language. |

## Analysis Scripts: `analysis/`

| File | Plain English label |
| --- | --- |
| `analysis/generate_final_figures_r.R` | R script that creates the expanded final visualization package. |
...
These figures are generated by `analysis/generate_final_figures_r.R`.

| File | Plain English label |
| --- | --- |
| `results/final_figures/r_visualizations/r_visualizations_manifest.csv` | Manifest describing each R graph, data source, evidence type, sample size, and warning. |
| `results/final_figures/r_visualizations/r01_algorithm_architecture_grouped_bar.png` | Grouped bar graph comparing mean native depth by algorithm family and proxy architecture. |
| `results/final_figures/r_visualizations/r02_native_depth_distribution_boxplot.png` | Box plot showing the spread of native compiled depth. |
| `results/final_figures/r_visualizations/r03_gate_count_vs_fidelity_scatter.png` | Scatter plot comparing entangling-gate count and estimated success probability. |
| `results/final_figures/r_visualizations/r04_scaling_by_qubit_count_line.png` | Line graph showing routing SWAP changes across ordered qubit counts. |
| `results/final_figures/r_visualizations/r05_algorithm_architecture_heatmap.png` | Heat map showing where routing SWAP overhead is concentrated. |
| `results/final_figures/r_visualizations/r06_matched_architecture_slopegraph.png` | Slope graph comparing matched circuits across the two proxy architectures. |
| `results/final_figures/r_visualizations/r07_proxy_results_faceted.png` | Faceted graph showing several proxy metrics without mixing units. |
| `results/final_figures/r_visualizations/r08_ibm_hardware_probability_ci.png` | IBM hardware dot plot with Wilson confidence intervals by bit width. |
| `results/final_figures/r_visualizations/r09_quantinuum_emulator_results.png` | Quantinuum Nexus emulator validation graph. |
| `results/final_figures/r_visualizations/r10_evidence_summary.png` | Bar graph counting stored result records by evidence category. |
...
| File | Plain English label |
| --- | --- |
| `reports/R_VISUAL_ANALYSIS.md` | Concise report explaining the R visualization workflow and findings. |
