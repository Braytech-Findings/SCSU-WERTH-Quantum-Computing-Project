...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Compare superconducting and trapped-ion quantum architectures.")
    ...
    run_parser.add_argument("--backend", default="ideal", help="Backend selection: ideal, ibm, quantinuum, or all")
    run_parser.add_argument("--suite", default="core", help="Experiment suite identifier")
    run_parser.add_argument("--config", default="config/experiments.yaml", help="Path to YAML config")
...
def main() -> int:
    ...
    if args.command == "report":
        print("Report generation is not yet implemented; use the processed CSV output for now.")
        return 0
