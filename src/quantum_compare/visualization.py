...
def _write_report(
    ...
    lines = [
        ...
        f"- `{_display_path(figures_dir / 'quantinuum_validation_expected_state_probability.png')}`",
        "",
        "## Final Figure Set",
        "",
    ...
    lines.extend(
        [
            ...
            "`docs/QUANTINUUM_HARDWARE_VALIDATION.md`. The `H2-1E` and `H2-2E` targets accepted",
            "compilation but rejected execution for this account. The Nexus-hosted `H2-1LE` emulator",
            "target completed execution with 3 small circuits and 100 shots per circuit. Sanitized",
            "artifacts are stored in `results/hardware/quantinuum_submission_H2-1LE_20260714T173914Z.json`,",
            ...
            "provider emulator result, not a physical Quantinuum QPU measurement.",
            "",
            ...
            "  are not physical Quantinuum QPU measurements.",
